...
{
    [Fact]
    public async Task InitializeAsync_ExecutesCreateTableScript()
    {
        ...
        Assert.Contains("CREATE TABLE dbo.Appointments", connection.LastCommandText, StringComparison.Ordinal);
        Assert.Contains("CREATE INDEX IX_Appointments_Tenant_Service_SlotStart", connection.LastCommandText, StringComparison.Ordinal);
    }
